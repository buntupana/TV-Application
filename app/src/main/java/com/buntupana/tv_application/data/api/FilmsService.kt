...
interface FilmsService {
    ...
    fun fetchFilmList(): Response<FilmsResponse>

    @GET("/rtv/v1/GetVideo?client=json ")
    fun fetchFilm(@Query("external_id") filmId: String): Response<FilmResponse>
    ...
    fun fetchRecommendationList(@Path("filmId") filmId: String): Response<RecommendationResponse>
}